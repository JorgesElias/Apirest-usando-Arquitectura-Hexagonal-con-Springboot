package com.apirest.app.infrastructure.adapters.output.persistence;
...
import com.apirest.app.infrastructure.adapters.output.persistence.mapper.StudentPersistenceMapper;
import com.apirest.app.infrastructure.adapters.output.persistence.repository.StudentRepository;

import lombok.RequiredArgsConstructor;
@Component
@RequiredArgsConstructor
public class StudentPersistenceAdapter  implements StudenPersistencePort{
